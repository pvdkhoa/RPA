"""
This script automates the process of selecting the 'Car' insurance type 
and performing a search on the DB Insurance application.
"""
...
click(644, 219)
print('Clicked Selection Item Car')
time.sleep(3)
